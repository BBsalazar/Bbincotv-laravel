...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{asset('vendors/Control.js')}}" />
        <link rel="stylesheet" href="{{asset('vendors/Amino/Keys.js')}}" />
    </head>

<body>
    <div id="tv_container">
        <video id="canal" controls autoplay loop>
            <source src="igmp://225.1.1.121:2001" type="video/mp4">
...
function KeyHandler(e) {
        ...
        switch (PressedKey) {
            ...
            var obj_video = document.getElementById(id);
            var source = obj_video.getElementsByTagName('source')[0];
            source.setAttribute('src', Video);
            }
            cambiarVideo('canal','')
            alert("Se cambio el video")
			break;
        }
}
</script>
